        ...
        <div className="col-sm-9 col-centered mt-4">
          ...
          <div className="row border border-secondary">
            <div className="col-sm-8">
              <h4 pb-3>First challenge starts Dec. 28, 2020</h4>
              <p>The first challenge will be starting on December 28th, 2020!</p>
              <p>If you are looking to participate, please make sure you <a href="https://forms.gle/aL1wt4wSevjWyE969" target="_blank">sign up</a> before December 24th!</p>
